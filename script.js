...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const startMessage = "Eks sa klikka peale kui juba siia tulid";
...
function initializeVisitorCounter() {
    const manualCount = 22412; 

    if (visitorCount) {
      visitorCount.textContent = manualCount.toLocaleString();
    }
    
    console.log("Visitor count set manually to: " + manualCount);
  }
  ...
  const bioMessages = [
    "No tere!",
    "Ega siin palju pole paar linki ja mingi beat",
    "Sai valmis 7:02 AM",
    "Nojah...",
    "Miks siin veel tiksud?",
    "Kui beat meeldib siis nimeks on Roi - Videoclub",
    "Kui sa juba nii kiindunud oled siis discord on: szhdk"
